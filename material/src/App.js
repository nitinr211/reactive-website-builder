...
function App() {
  ...
  return (
    ...
    <MDBContainer className="p-3 my-5 d-flex flex-column w-50">
      <h1 className="text-center mb-4">Digicraft Login</h1>
      ...
      <MDBTabsContent>
        <MDBTabsPane show={justifyActive === 'tab1'}>
          ...
          <MDBBtn className="mb-4 w-100">Sign in to Digicraft</MDBBtn>
          <p className="text-center">Not a member? <a href="#!">Register now</a></p>
        </MDBTabsPane>
        ...
        <MDBTabsPane show={justifyActive === 'tab2'}>
          ...
          <MDBInput wrapperClass='mb-4' label='Full Name' id='registerName' type='text' />
          ...
          <MDBBtn className="mb-4 w-100">Create Digicraft Account</MDBBtn>
        </MDBTabsPane>
      </MDBTabsContent>
    </MDBContainer>
  );
